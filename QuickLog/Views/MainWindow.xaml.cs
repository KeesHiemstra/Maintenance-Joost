...
namespace QuickLog
{
	...
	public partial class MainWindow : Window
	{
      ...
      Title = $"{name} - {version}";
			...
			OptionList.Add("Afternoon event");
			...
			if (VM.Option == MainViewModel.Options.Calender || VM.Option == MainViewModel.Options.AfternoonEvent)
			{
		...
		private void ProcessCommandLineArgs(string[] args)
		{
			...
			if (args.Length > 2)
			{
				...
				else if (args[2].ToLower() == "/bedtime")
				{
					OptionComboBox.SelectedItem = "BedTime";
					VM.Option = MainViewModel.Options.BedTime;
				}
				else if (args[2].ToLower() == "/afternoonevent")
				{
					OptionComboBox.SelectedItem = "Afternoon event";
		...
		/// <summary>
		/// Handle the keys - and = to change the date.
		/// </summary>
